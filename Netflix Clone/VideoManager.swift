...
enum Query: String, CaseIterable {
    case nature, animals, people, ocean, aeshtetic, food, concerts
}
...
class VideoManager: ObservableObject {
    ...
    func findVideos(topic: Query) async {
        ...
        urlRequest.setValue("XMh2EGfCiXRbES61vWNqqNmBCwrjUEbNhUexOc906D3hNRunkwut0IMo", forHTTPHeaderField: "Authorization")
